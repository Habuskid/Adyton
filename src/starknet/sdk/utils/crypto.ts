import { ec, BigNumberish } from "starknet";
import { toHex, toBytes, toBigInt, uint8ArrayToBigInt } from "./convert.js";
...
export function generateRandom(): bigint {
  ...
  return uint8ArrayToBigInt(starkCurve.utils.randomPrivateKey());
}
